...
class ImageViewer(QWidget):
    ...
    def __init__(self,annt_path, dpath1, dpath2):
        ...
        self.sorted_diff_list = self.cal_diff()
    ...
    def cal_diff(self):
        annots1 = os.listdir(self.dpath1)
        assert len(annots1) == 4
        annots2 = os.listdir(self.dpath2)
        assert len(annots2) == 4
        ...
        for annt1 in annots1:
            annt_file = osp.join(self.dpath1, annt1)
        ...
        for annt2 in annots2:
            annt_file = osp.join(self.dpath2, annt2)
            with jsonlines.open(annt_file) as fp:
                for obj in fp:
